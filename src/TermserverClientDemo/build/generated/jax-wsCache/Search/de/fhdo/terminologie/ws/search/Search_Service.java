 ...
 * 
 */
@WebServiceClient(name = "Search", targetNamespace = "http://search.ws.terminologie.fhdo.de/", wsdlLocation = "http://193.25.22.69:8080/TermServer/Search?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://193.25.22.69:8080/TermServer/Search?wsdl");
